...
@section('body')
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{route('admin/addteacher')}}">
                        ...
                        <span class="nav-link-text ms-1">Öğrentmen Ekle</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{route('admin/addstudent')}}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @if( $userGroupId == 2 )
                <div class="container-fluid px-2 px-md-4">
                    ...
                    <div class="card card-body mx-3 mx-md-4 mt-n10">
                        ...
                        <h4 style="margin: auto" class="font-weight-bolder text-center mt-2 mb-0 pb-4">Öğrenciler</h4>
                        <div class="row">
                            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Proje Adı</th>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Dönem</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($students as $item)
                                        @php
                                            $projectFind = \App\Models\Project_Idea::where('student_no', $item['student_no'])->orderBy("date_stamp","desc")->first();
                                            if(isset($projectFind['project_title'])){
                                                $semesterFind = \App\Models\Semester::where('semester_id', $projectFind['semester_id'])->first();
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-xs font-weight-bold">{{isset($projectFind['project_title']) ? $projectFind['project_title'] : "-"}}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-xs font-weight-bold">{{isset($semesterFind['semester_name']) ? $semesterFind['semester_name'] : "-"}}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
    ...
    @endif
    {{-- Kullanıcı öğrenciyse --}}
    @if( request()->get('userGroupId') == 3 )
        @php
            $id = request()->get('id');
                        ...
                        <div class="table-responsive">
                            <table  class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">Durum</th>
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Dönem</th>
                                </tr>
                                </thead>
                                <tbody>
