    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div style="height: 450px" class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{route('admin/semester')}}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h5 class="text-white text-capitalize ps-5"><i class="fas fa-graduation-cap fa-lg"></i>&nbsp; Dönemler
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive">
                                <form enctype="multipart/form-data" action="{{route('admin/semester')}}" method="post">
                                    @csrf
                                    <table class="table align-items-center mb-0">
                                            ...
                                            <td colspan="3">
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Dönem Adı ve Yılı:</h6>
                                                        <p style="font-size: 10px;"><strong>*Lütfen dönem yılı ve adını giriniz.(örnek:"2021-2022 Güz")</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    <label class="form-label">Dönem Adı ve Yılı.</label>
                                                    <input name="semesterName" type="text" class="form-control">
                                                </div>
                                            </td>
                                            <td colspan="3">
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Aktif Dönem:</h6>
                                                        <p style="font-size: 10px;"><strong>*Lütfen aktif dönemi seçiniz.</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    <select class="form-control" name="semesterSelect">
                                                        <option disabled selected value> -- Dönem -- </option>
                                        ...
                                        <tr>
                                            <td colspan="6" style="text-align: center;">
                                                <button class="btn bg-gradient-dark mb-0" name="action" type="submit" value="donemEkle">Dönem Ekle</button>
                                            </td>
                                            <td colspan="6" style="text-align: center;">
                                                <button class="btn bg-gradient-dark mb-0" name="action" type="submit" value="donemSec">Dönem Seç</button>
                                            </td>
                                        </tr>
