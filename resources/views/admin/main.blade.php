                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Danışman</th>
                                    ...
                                    @foreach($student as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-xs font-weight-bold">{{$teacher['name']." ".$teacher['surname']}}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                            <span class="text-xs font-weight-bold">
                                                <form action="{{route('admin/user')}}" method="get">
                                                    <input name="id" type="hidden" value="{{isset($user['user_id']) ? $user['user_id'] : false}}">
                                                    <input name="userGroupId" type="hidden" value="{{isset($user['user_group_id']) ? $user['user_group_id'] : false}}">
...
{{--                                </nav>--}}
                    ...
                    <div class="card mt-6">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h5 class="text-white text-capitalize ps-5"><i class="fas fa-user-tie fa-lg"></i>&nbsp; Danışman Öğretmenler</h5>
                            </div>
                        </div>
                        <!-- border bottom -->
                        <div class="card-header pb-0" style="margin-top:10px;border-top:1px solid #f0f2f5;"></div>
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                    <tr>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Öğretmen No</th>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Ünvan</th>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Ad Soyad</th>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">Bölüm</th>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">İşlemler</th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-xs font-weight-bold">{{$item['teacher_no']}}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-xs font-weight-bold">
                                                <form action="{{route('admin/user')}}" method="get">
                                                    ...
                                                    <input name="userGroupId" type="hidden" value="{{$user['user_group_id']}}">
                                                    <button type="submit" class="btn btn-info btn-sm m-0">
                                                        Görüntüle
                                                    </button>
                                                </form>
