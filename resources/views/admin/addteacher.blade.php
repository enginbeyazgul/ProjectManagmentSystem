    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div style="height: 450px" class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white  active bg-gradient-primary" href="{{route('admin/addteacher')}}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h5 class="text-white text-capitalize ps-5"><i class="fas fa-user-plus fa-lg"></i>&nbsp; Danışman Öğretmen Ekle
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive">
                                <form enctype="multipart/form-data" action="{{route('admin/addteacher')}}" method="post">
                                    @csrf
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Öğretmen No:</h6>
                                                        <p style="font-size: 10px;"><strong>*Lütfen öğretmen numarası giriniz.</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    <label class="form-label">Öğretmen Numarası.</label>
                                                    <input name="tNo" type="text" class="form-control">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    ...
                                                    <input name="tMail" type="email" class="form-control">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                            ...
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    ...
                                                    <input name="tSurname" type="text" class="form-control">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
...
{{--                                            </td>--}}
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Unvan:</h6>
                                                        <p style="font-size: 10px;"><strong>*Lütfen bir unvan giriniz.(örnek:"Doç.")</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    ...
                                                    <input name="tTitle" type="text" class="form-control">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div class="input-group input-group-outline">
                                                    <select id="department" class="form-control" name="tDepartment">
                                        ...
                                        <tr>
                                            <td colspan="7" style="
                          text-align: center;">
                                                <input class="btn bg-gradient-dark mb-0" type="submit" value="Öğretmen Ekle">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
